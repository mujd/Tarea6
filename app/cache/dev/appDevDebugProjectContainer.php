...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'tareas', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\MRF\\ClienteBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\MRF\\ProveedorBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\MRF\\UsuarioBundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\MRF\\RolBundle\\Entity'), 4 => ($this->targetDirs[3].'\\src\\MRF\\MenuBundle\\Entity'), 5 => ($this->targetDirs[3].'\\src\\MRF\\MenuRolBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'MRF\\ClienteBundle\\Entity');
        $c->addDriver($b, 'MRF\\ProveedorBundle\\Entity');
        $c->addDriver($b, 'MRF\\UsuarioBundle\\Entity');
        $c->addDriver($b, 'MRF\\RolBundle\\Entity');
        $c->addDriver($b, 'MRF\\MenuBundle\\Entity');
        $c->addDriver($b, 'MRF\\MenuRolBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('MRFClienteBundle' => 'MRF\\ClienteBundle\\Entity', 'MRFProveedorBundle' => 'MRF\\ProveedorBundle\\Entity', 'MRFUsuarioBundle' => 'MRF\\UsuarioBundle\\Entity', 'MRFRolBundle' => 'MRF\\RolBundle\\Entity', 'MRFMenuBundle' => 'MRF\\MenuBundle\\Entity', 'MRFMenuRolBundle' => 'MRF\\MenuRolBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_46142a7c866d88086defa3f565d12c72bee2e45ef996fc12d56791c2865edf60');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\MRF\\HomeBundle/Resources/views'), 'MRFHome');
        $instance->addPath(($this->targetDirs[3].'\\src\\MRF\\ClienteBundle/Resources/views'), 'MRFCliente');
        $instance->addPath(($this->targetDirs[3].'\\src\\MRF\\ProveedorBundle/Resources/views'), 'MRFProveedor');
        $instance->addPath(($this->targetDirs[3].'\\src\\MRF\\UsuarioBundle/Resources/views'), 'MRFUsuario');
        $instance->addPath(($this->targetDirs[3].'\\src\\MRF\\RolBundle/Resources/views'), 'MRFRol');
        $instance->addPath(($this->targetDirs[3].'\\src\\MRF\\MenuBundle/Resources/views'), 'MRFMenu');
        $instance->addPath(($this->targetDirs[3].'\\src\\MRF\\MenuRolBundle/Resources/views'), 'MRFMenuRol');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58ae07f100fa62.25539435')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MRFHomeBundle' => 'MRF\\HomeBundle\\MRFHomeBundle',
                'MRFClienteBundle' => 'MRF\\ClienteBundle\\MRFClienteBundle',
                'MRFProveedorBundle' => 'MRF\\ProveedorBundle\\MRFProveedorBundle',
                'MRFUsuarioBundle' => 'MRF\\UsuarioBundle\\MRFUsuarioBundle',
                'MRFRolBundle' => 'MRF\\RolBundle\\MRFRolBundle',
                'MRFMenuBundle' => 'MRF\\MenuBundle\\MRFMenuBundle',
                'MRFMenuRolBundle' => 'MRF\\MenuRolBundle\\MRFMenuRolBundle',
            ...
            'locale' => 'en',
            'app.fono_largo_default' => '999999999',
